...
CONFIG_FIELDS=(
    ...
    "ECS_CLUSTER_NAME|alphanumeric_dash|cdx-jit-db-cluster|ECS Cluster Name|*|false"
    ...
    "BUCKET_NAME|alphanumeric_dash|cdx-jit-db-logs|S3 Bucket Name (for query logs)|*|false"
    ...
    "DB_VPC_ID|nonempty||Database VPC ID|new-vpc,existing-vpc|false"
    "DB_VPC_CIDR|cidr||Database VPC CIDR|new-vpc|false"
    "DB_SECURITY_GROUP_IDS|nonempty||RDS Security Group IDs (comma-separated)|new-vpc,existing-vpc|false"
