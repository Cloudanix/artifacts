...
CONFIG_FIELDS=(
    ...
    "ECS_CLUSTER_MODE|nonempty|new|Create a new ECS cluster or reuse an existing one? (new/existing)|new-vpc,existing-vpc|false"
    "ECS_CLUSTER_NAME|alphanumeric_dash|cdx-jit-k8s-cluster|ECS cluster name — new one to create, or existing cluster name to reuse (e.g. cdx-jit-db-cluster)|new-vpc,existing-vpc|false"
